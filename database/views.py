...
def search(request):
    if request.method == "POST":
        ...
        context = {'d': final_df.to_dict(orient='records'), 'column_names': final_df.columns.tolist()}
...
def third_search(request):
    if request.method == "POST":
        ...
        print(results_3d)
        # Create a results dictionary
        results_dict = results_3d[['ID','STR_LINK (SMILES)', '3d_similarity','IMMUNE SYTEM FUNCTION UNAFFECTED','IMMUNE SYSTEM-Function enhanced/numbers increased','IMMUNE SYSTEM-Function inhibited/numbers decreased','NEGATIVE IMMUNE SYTEM REGULATION-Function enhanced/numbers incr']].to_dict(orient='records')
...
def substructure_search(request):
    if request.method == "POST":
        ...
        # Create a results dictionary
        results_dict = results_substructure[['ID','STR_LINK (SMILES)', 'substructure_match','IMMUNE SYTEM FUNCTION UNAFFECTED','IMMUNE SYSTEM-Function enhanced/numbers increased','IMMUNE SYSTEM-Function inhibited/numbers decreased','NEGATIVE IMMUNE SYTEM REGULATION-Function enhanced/numbers incr']].to_dict(orient='records')
...
def maccs_search(request):
    if request.method == "POST":
        ...
        # Create a results dictionary
        results_dict = results_maccs[['ID','STR_LINK (SMILES)', 'maccs_similarity','IMMUNE SYTEM FUNCTION UNAFFECTED','IMMUNE SYSTEM-Function enhanced/numbers increased','IMMUNE SYSTEM-Function inhibited/numbers decreased','NEGATIVE IMMUNE SYTEM REGULATION-Function enhanced/numbers incr']].to_dict(orient='records')
