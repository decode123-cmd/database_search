...
def tanimoto_search(request):
    if request.method == "POST":
        ...
        results_dict = results_2d[['ID','STR_LINK (SMILES)', '2d_similarity','IMMUNE SYTEM FUNCTION UNAFFECTED','IMMUNE SYSTEM-Function enhanced/numbers increased','IMMUNE SYSTEM-Function inhibited/numbers decreased','NEGATIVE IMMUNE SYTEM REGULATION-Function enhanced/numbers incr']].to_json(orient='records')
...
def third_search(request):
    if request.method == "POST":
        ...
        print(results_3d)
        # Create a results dictionary
        results_dict = results_3d[['ID','STR_LINK (SMILES)', '3d_similarity','IMMUNE SYTEM FUNCTION UNAFFECTED','IMMUNE SYSTEM-Function enhanced/numbers increased','IMMUNE SYSTEM-Function inhibited/numbers decreased','NEGATIVE IMMUNE SYTEM REGULATION-Function enhanced/numbers incr']].to_json(orient='records')
...
def substructure_search(request):
    if request.method == "POST":
        ...
        # Create a results dictionary
        results_dict = results_substructure[['ID','STR_LINK (SMILES)', 'substructure_match','IMMUNE SYTEM FUNCTION UNAFFECTED','IMMUNE SYSTEM-Function enhanced/numbers increased','IMMUNE SYSTEM-Function inhibited/numbers decreased','NEGATIVE IMMUNE SYTEM REGULATION-Function enhanced/numbers incr']].to_json(orient='records')
...
def maccs_search(request):
    if request.method == "POST":
        ...
        # Create a results dictionary
        results_dict = results_maccs[['ID','STR_LINK (SMILES)', 'maccs_similarity','IMMUNE SYTEM FUNCTION UNAFFECTED','IMMUNE SYSTEM-Function enhanced/numbers increased','IMMUNE SYSTEM-Function inhibited/numbers decreased','NEGATIVE IMMUNE SYTEM REGULATION-Function enhanced/numbers incr']].to_json(orient='records')
